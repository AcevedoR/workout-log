            ...
            <h3 className="text-center">last workouts</h3>
            {
                workoutList.map((workout, i) => (
                    <div>
                        ...
                        <span
                            className="tag w-full text-center text-2xl font-medium text-gray-700 group-hover:text-green-900">
                          <svg className="mx-auto h-6 w-6" aria-hidden="true" fill="none" stroke="currentColor"
                               stroke-width="2"
