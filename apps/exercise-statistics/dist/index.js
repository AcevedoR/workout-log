...
export var calculate = onRequest(function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var original;
    return __generator(this, function (_a) {
        ...
        res.json({ result: "hey back ".concat(req.query, " ").concat(req.body) });
        return [2 /*return*/];
    });
}); });
export function calculateUsualLift() {
